(function () {
	...
	var Theme = (function (Component$$1) {
	    ...
	    Theme.prototype.render = function render$$1 (ref) {
	...
	var rules = [function(root){ return ("." + (root.cn) + "{font-family:Arial, Helvetica, sans-serif;color:#404040;}")}];

	var rules$1 = [function(root){ return ("." + (root.cn) + "{font-size:30px;}")},function(root){ return ("." + (root.cn) + "[" + (root.px) + "size=medium]{font-size:20px;}")},function(root){ return ("." + (root.cn) + "[" + (root.px) + "size=small]{font-size:10px;}")}];

	var Title = style("div")(rules$1);

	var Layout = style("main")(rules);

	render(
	    h( Layout, null, 
	        h( Title, null, "normal" ), 
	        h( Title, { size: "small" }, "small"), 
	        h( Title, { size: "medium" }, "medium")
	    ),
	    document.body
	);
